...
public class ContextedString<A extends StringArgument> implements Comparable<ContextedString<?>> {
    ...
    public void setArgumentCreator(final Supplier<A> argumentCreator) {
        this.argumentCreator = argumentCreator;
    }

    public void setArgumentCreatorIndexed(final BiFunction<Integer, String[], A> argumentCreatorIndexed) {
        this.argumentCreatorIndexed = argumentCreatorIndexed;
    }

    public void setArgs(final ConcurrentSkipListSet<A> args) {
        this.args = args;
    }
}
