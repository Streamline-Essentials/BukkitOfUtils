...
public class ItemBin {
    ...
    public static void setBin(final ConcurrentSkipListSet<ConvertableItemStack> bin) {
        ItemBin.bin = bin;
    }

    public static AtomicInteger getAtomicNextId() {
        return ItemBin.atomicNextId;
    }

    public static void setAtomicNextId(final AtomicInteger atomicNextId) {
        ItemBin.atomicNextId = atomicNextId;
    }
}
