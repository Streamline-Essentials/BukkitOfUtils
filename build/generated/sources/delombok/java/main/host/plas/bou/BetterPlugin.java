...
public class BetterPlugin extends JavaPlugin implements IModifierEventable, Identified, WithSync, BaseEventListener, ListenerConglomerate {
    ...
    public static SyncInstance getSyncInstance() {
        return BetterPlugin.syncInstance;
    }

    public static void setSyncInstance(final SyncInstance syncInstance) {
        BetterPlugin.syncInstance = syncInstance;
    }

    public static TaskScheduler getScheduler() {
        return BetterPlugin.scheduler;
    }

    public static void setScheduler(final TaskScheduler scheduler) {
        BetterPlugin.scheduler = scheduler;
    }
}
