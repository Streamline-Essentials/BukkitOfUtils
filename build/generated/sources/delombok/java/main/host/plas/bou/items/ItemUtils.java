...
public class ItemUtils {
    ...
    public static Optional<String> getTag(ItemStack stack, JavaPlugin plugin, String key) {
        ...
        String value = null;
        if (meta != null) {
            if (meta.getPersistentDataContainer().has(PluginUtils.getPluginKey(plugin, key), PersistentDataType.STRING)) value = meta.getPersistentDataContainer().get(PluginUtils.getPluginKey(plugin, key), PersistentDataType.STRING);
        }
        return Optional.ofNullable(value);
    }

    public static ItemStackSerializer getStackSerializer() {
        return ItemUtils.stackSerializer;
    }

    public static void setStackSerializer(final ItemStackSerializer stackSerializer) {
