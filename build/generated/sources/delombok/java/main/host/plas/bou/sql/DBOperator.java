...
//            Connection rawConnection = getConnectionMap().get(qStart);
    ...
    public void setConnectorSet(final ConnectorSet connectorSet) {
        this.connectorSet = connectorSet;
    }
    ...
    public void setPluginUser(final BetterPlugin pluginUser) {
        this.pluginUser = pluginUser;
    }

    public void setRawConnection(final Connection rawConnection) {
        this.rawConnection = rawConnection;
    }

    public void setAlterMap(final ConcurrentSkipListMap<String, String> alterMap) {
