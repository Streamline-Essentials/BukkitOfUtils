...
public class ScreenManager {
    ...
    public static GuiMaintenanceListener getGuiMaintenanceListener() {
        return ScreenManager.guiMaintenanceListener;
    }

    public static void setGuiMaintenanceListener(final GuiMaintenanceListener guiMaintenanceListener) {
    ...
    public static void setScreens(final ConcurrentSkipListSet<ScreenInstance> screens) {
        ScreenManager.screens = screens;
    }

    public static ConcurrentSkipListSet<ScreenBlock> getLoadedBlocks() {
        return ScreenManager.loadedBlocks;
    }

    public static void setLoadedBlocks(final ConcurrentSkipListSet<ScreenBlock> loadedBlocks) {
