...
//                    BukkitOfUtils.getInstance().logWarning("Failed to unregister expansion " + expansion.getIdentifier() + " from PlaceholderAPI.");
    ...
    public static ConcurrentSkipListSet<BetterExpansion> getLoadedExpansions() {
        return PAPIHolder.loadedExpansions;
    }

    public static void setLoadedExpansions(final ConcurrentSkipListSet<BetterExpansion> loadedExpansions) {
        PAPIHolder.loadedExpansions = loadedExpansions;
    }

    public static BouExpansion getOwnExpansion() {
        return PAPIHolder.ownExpansion;
    }

    public static void setOwnExpansion(final BouExpansion ownExpansion) {
    ...
    public void setEnableOverride(final int enableOverride) {
