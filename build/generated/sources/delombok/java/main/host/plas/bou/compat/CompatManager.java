...
public class CompatManager {
    ...
    public static ConcurrentSkipListMap<String, HeldHolder> getHolders() {
        return CompatManager.holders;
    }

    public static void setHolders(final ConcurrentSkipListMap<String, HeldHolder> holders) {
        CompatManager.holders = holders;
    }

    public static ConcurrentSkipListMap<Integer, CompatibilityManager> getManagers() {
        return CompatManager.managers;
    }

    public static void setManagers(final ConcurrentSkipListMap<Integer, CompatibilityManager> managers) {
