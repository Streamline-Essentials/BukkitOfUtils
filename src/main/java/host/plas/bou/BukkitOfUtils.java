...
//        instance = this; // Set earlier.
    ...
    public Helpful getHelpful() {
        return new Helpful(this.getHelpfulInfo(), new String[]{"&eA utility plugin for Bukkit-based servers.", "&eProvides various utilities, commands, and features to enhance server management and gameplay experience.", "&r", "&eCommands Included:", "&b- /debug: &7Toggle debug mode.", "&b- /entitycount: &7Check entity counts on the server.", "&b- /firestring: &7Execute Fire Strings for dynamic actions.", "&b- /message: &7Send custom messages to players.", "&b- /title: &7Display titles to players.", "&b- /boup: &7Manage BetterPlugins (list/enable/disable/info/reload/load/unload/menu).", "&b- /onemenu: &7Configurable one-stop GUI (when enabled in base-config).", "&r", "&eFor more information, visit the wiki:", "&bhttps://wiki.drak.gg/bukkitofutils/"});
    }
}
